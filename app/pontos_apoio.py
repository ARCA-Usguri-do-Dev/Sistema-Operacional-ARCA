...
pontos_apoio = [
    {'id': 1, 'nome': 'Centro Comunitário Paulista', 'bairro': 'Bela Vista', 'rua': 'Av. Paulista, 1000', 'cidade': 'São Paulo', 'estado': 'SP', 'pais': 'Brasil', 'capacidade': 800, 'telefone': '+55 11 3333-4444', 'status': 'Aprovado', 'lat': -23.5505, 'lon': -46.6333, 'observacoes': 'Observações: O ponto de apoio aceita animais, possui acesso para deficientes físicos e cadeiras de rodas.'},
